...
export const Navbar = () => {
  return (
    <div className=' flex items-center justify-between pr-4'>
        ...
        <div className='hover:bg-white transition-all cursor-pointer duration-300 ease-in-out hover:text-black hidden md:flex items-center space-x-2 bg-[#2b2d2d] p-2 px-4 rounded-full'>
            <p>LET'S TALK</p>
